...
as could be applied as a TA guiding us through the debugging process if Google were no help and no actual TA was nearby.
<br><br>
...
As these workflows are mostly boilerplate and not part of the actual application code,
it did not take away from our learning experience but simply allowed us to prioritize our time and ressources in other areas.
