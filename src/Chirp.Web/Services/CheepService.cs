...
public class CheepService : ICheepService
{
    ...
    public List<CheepDTO> GetCheepsFromAuthors(IList<string> authorIds, out bool hasNext, int? page = null)
    {
        var cheeps = _cheepRepository.ReadCheepsBySelfAndOthers(authorIds,page).Result;
