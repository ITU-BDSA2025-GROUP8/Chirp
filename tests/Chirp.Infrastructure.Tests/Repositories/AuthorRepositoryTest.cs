...
public class AuthorRepositoryTest : IDisposable
{
    ...
    public async Task FindByName()
    {
        ...
        context.Cheeps.AddRange(
            new Cheep { Author = a1, Text = "hello", Date = new DateTime(2025, 10, 10),LikedBy = [] },
            new Cheep { Author = a1, Text = "world", Date = new DateTime(2025, 10, 11),LikedBy = [] },
            new Cheep { Author = a2, Text = "cheep", Date = new DateTime(2025, 10, 12),LikedBy = [] }
        );
        context.SaveChanges();
